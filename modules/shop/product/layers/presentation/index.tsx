...
// context
import { ProductAPIContext } from '@md-shop-product/layers/api/product';
import { ProductBLContext } from '@md-shop-product/layers/business';
import { CartBLContext } from '@md-shop-cart/layers/business';
// view components
import { ContentLoader } from '@md-ui/loaders/content-loader';
import { ProductInfo } from '@md-shop-product/components/product-info';
// views
import {
  ContentWrapper,
